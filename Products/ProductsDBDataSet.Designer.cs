...
namespace Products {
    ...
    public partial class ProductsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(int ProductId, string Product_Name, string Description, int Units_on_Hand, decimal Price) {
            ...
            internal void InitVars() {
                ...
                this.columnUnits_on_Hand = base.Columns["Units on Hand"];
            ...
            private void InitClass() {
                ...
                this.columnUnits_on_Hand = new global::System.Data.DataColumn("Units on Hand", typeof(int), null, global::System.Data.MappingType.Element);
...
namespace Products.ProductsDBDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Units on Hand", "Units on Hand");
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([Pro" +
                "duct Name] = @Original_Product_Name) AND ([Description] = @Original_Description)" +
                " AND ([Units on Hand] = @Original_Units_on_Hand) AND ([Price] = @Original_Price)" +
                ")";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Units_on_Hand", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Units on Hand", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductId], [Product Name], [Description], [Units on Hand], [Price]) VALUES (@ProductId, @Product_Name, @Description, @Units_on_Hand, @Price);
SELECT ProductId, [Product Name], Description, [Units on Hand], Price FROM Products WHERE (ProductId = @ProductId)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Units_on_Hand", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Units on Hand", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductId] = @ProductId, [Product Name] = @Product_Name, [Description] = @Description, [Units on Hand] = @Units_on_Hand, [Price] = @Price WHERE (([ProductId] = @Original_ProductId) AND ([Product Name] = @Original_Product_Name) AND ([Description] = @Original_Description) AND ([Units on Hand] = @Original_Units_on_Hand) AND ([Price] = @Original_Price));
SELECT ProductId, [Product Name], Description, [Units on Hand], Price FROM Products WHERE (ProductId = @ProductId)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Units_on_Hand", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Units on Hand", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Units_on_Hand", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Units on Hand", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Products.Properties.Settings.Default.ProductsDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, [Product Name], Description, [Units on Hand], Price FROM dbo.Pr" +
                "oducts";
        ...
        public virtual int Delete(int Original_ProductId, string Original_Product_Name, string Original_Description, int Original_Units_on_Hand, decimal Original_Price) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_Units_on_Hand));
        ...
        public virtual int Insert(int ProductId, string Product_Name, string Description, int Units_on_Hand, decimal Price) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Units_on_Hand));
        ...
        public virtual int Update(int ProductId, string Product_Name, string Description, int Units_on_Hand, decimal Price, int Original_ProductId, string Original_Product_Name, string Original_Description, int Original_Units_on_Hand, decimal Original_Price) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Units_on_Hand));
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Units_on_Hand));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Product_Name, string Description, int Units_on_Hand, decimal Price, int Original_ProductId, string Original_Product_Name, string Original_Description, int Original_Units_on_Hand, decimal Original_Price) {
            return this.Update(Original_ProductId, Product_Name, Description, Units_on_Hand, Price, Original_ProductId, Original_Product_Name, Original_Description, Original_Units_on_Hand, Original_Price);
        }
    }
